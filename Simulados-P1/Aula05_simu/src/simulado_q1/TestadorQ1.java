...
public class TestadorQ1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("porcentagem "+ ub.porcentagemVerificados());
		System.out.println(ub.tamanhoMedioTweets());

		VerifiedUser aline = ub.createVerifiedUser("alinemanhaes", new Date());
		aline.addTweet(new Tweet("quero tirar 10 em POO..."));
